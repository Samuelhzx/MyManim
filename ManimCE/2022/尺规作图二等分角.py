...
class m1(creates):
    def construct(self):
        ...
        t1 = Text("二等分角的作法：")
        t2 = Tex(
            "(1)在OA、OB上分别截取OD、OE，使OD=OE", tex_template=TexTemplateLibrary.ctex
        ).scale(0.5)
        t3 = Tex(
            "(2)分别以点D、E为圆心，以大于",
            r"$\frac{1}{2} $",
        ...
        t32 = Tex(
            "两弧交于", r"$\angle$", "AOB内的一点C", tex_template=TexTemplateLibrary.ctex
        ).scale(0.5)
        ...
        dot3 = Dot(points[0], color="#15ff00").shift(
